...
const Navbar = ({ scrollToService, scrollToProperties, scrollToInquire }) => {
  ...
  return (
    <div className="w-full h-20 px-5 flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="mt-4 md:mt-0 flex items-center">
        ...
        <span className="border-l border-gray-300 h-6 mx-2"></span>
        <button className="px-4 py-2 text-sm md:text-base" onClick={handleClickCareer}>Careers</button>
      </div>
